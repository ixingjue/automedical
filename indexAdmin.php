...
if(!$info){
	echo "<script>alert('没有文件或目录！！！');location.href='indexAdmin.php';</script>";
}
//print_r($info);
$redirect="indexAdmin.php?path={$path}";
if($act=="创建文件"){
	//创建文件
//	echo $path,"--";
//	echo $filename;
...
EOF;
	...
	//echo $content;
	$str=<<<EOF
	<form action='indexAdmin.php?act=doEdit' method='post'> 
...
EOF;
	...
	//完成重命名
	$str=<<<EOF
	<form action="indexAdmin.php?act=doRename" method="post"> 
...
echo $str;
	...
	$str=<<<EOF
			<form action="indexAdmin.php?act=doRenameFolder" method="post"> 
...
echo $str;
	...
	alertMes($mes,$redirect);
		...
		$str=<<<EOF
	<form action="indexAdmin.php?act=doCopyFolder" method="post"> 
...
echo $str;
	...
	alertMes($mes,$redirect);
			...
			$str=<<<EOF
	<form action="indexAdmin.php?act=doCutFolder" method="post"> 
...
echo $str;
	...
	alertMes($mes,$redirect);
				...
				$str=<<<EOF
	<form action="indexAdmin.php?act=doCopyFile" method="post"> 
...
echo $str;
	...
	alertMes($mes,$redirect);
				...
				$str=<<<EOF
	<form action="indexAdmin.php?act=doCutFile" method="post"> 
...
<script type="text/javascript">
	...
	function delFile(filename,path){
		if(window.confirm("您确定要删除嘛?删除之后无法恢复哟!!!")){
				location.href="indexAdmin.php?act=delFile&filename="+filename+"&path="+path;
		}
	}
	function delFolder(dirname,path){
		if(window.confirm("您确定要删除嘛?删除之后无法恢复哟!!!")){
			location.href="indexAdmin.php?act=delFolder&dirname="+dirname+"&path="+path;
		}
	}
	...
	function goBack($back){
		location.href="indexAdmin.php?path="+$back;
	}
</script>
</head>
...
<div id="top">
	<ul id="navi">
		<li><a href="indexAdmin.php" title="主目录"><span style="margin-left: 8px; margin-top: 0px; top: 4px;" class="icon icon-small icon-square"><span class="icon-home"></span></span></a></li>
...
?>
	<tr>
		...
		?>
		<a href="indexAdmin.php?act=showContent&path=<?php echo $path;?>&filename=<?php echo $p;?>" ><img class="small" src="images/show.png"  alt="" title="查看"/></a>|
		<?php }?>
		<a href="indexAdmin.php?act=editContent&path=<?php echo $path;?>&filename=<?php echo $p;?>"><img class="small" src="images/edit.png"  alt="" title="修改"/></a>|
		<a href="indexAdmin.php?act=renameFile&path=<?php echo $path;?>&filename=<?php echo $p;?>"><img class="small" src="images/rename.png"  alt="" title="重命名"/></a>|
		<a href="indexAdmin.php?act=copyFile&path=<?php echo $path;?>&filename=<?php echo $p;?>"><img class="small" src="images/copy.png"  alt="" title="复制"/></a>|
		<a href="indexAdmin.php?act=cutFile&path=<?php echo $path;?>&filename=<?php echo $p;?>"><img class="small" src="images/cut.png"  alt="" title="剪切"/></a>|
		<a href="#"  onclick="delFile('<?php echo $p;?>','<?php echo $path;?>')"><img class="small" src="images/delete.png"  alt="" title="删除"/></a>|
		<a href="indexAdmin.php?act=downFile&path=<?php echo $path;?>&filename=<?php echo $p;?>"><img class="small"  src="images/download.png"  alt="" title="下载"/></a>
		</td>		
	</tr>
<?php 
$i++;
...
?>
	<tr>
		...
		<td><?php echo date("Y-m-d H:i:s",fileatime($p));?></td>
		<td>
		<a href="indexAdmin.php?path=<?php echo $p;?>" ><img class="small" src="images/show.png"  alt="" title="查看"/></a>|
		<a href="indexAdmin.php?act=renameFolder&path=<?php echo $path;?>&dirname=<?php echo $p;?>"><img class="small" src="images/rename.png"  alt="" title="重命名"/></a>|
		<a href="indexAdmin.php?act=copyFolder&path=<?php echo $path;?>&dirname=<?php echo $p;?>"><img class="small" src="images/copy.png"  alt="" title="复制"/></a>|
		<a href="indexAdmin.php?act=cutFolder&path=<?php echo $path;?>&dirname=<?php echo $p;?>"><img class="small" src="images/cut.png"  alt="" title="剪切"/></a>|

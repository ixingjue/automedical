    ...
    <head>
        ...
        <link href='http://fonts.googleapis.com/css?family=Oswald:400,300,700' rel='stylesheet' type='text/css'>
            ...
            ?>
			  ...
			  <li><a href="./php/logout.php" class="login_out" hidefocus="true" onClick="javascript:window.opener=null;window.close()";>退出</a></li>
...
$tvp[]=$rs['id'];
		...
		$onset[]=$v;
		 for($t=0;$t<=2;$t++){
		     $sql_1 ="select * from article where id=$onset[$t]";
			 $result=mysql_query($sql_1);
			 $rw=mysql_fetch_assoc($result);			
?> 
<span class="Title"><a href="./php/article.php?id=<?php echo $onset[$t]; ?>" target="_blank">
<?php
echo $rw["title"];
echo "<br/>";
?>
...
?>  
		...
		$offset[]=$v;
		for($i=0;$i<=3;$i++){
        $sql_2="select title,content from knowledge where id=$offset[$i]";//数据库提取数据
        ...
        ?> 
                    ...
                    <div class="search">
                        <div class="search-input">
                            ...
                            <form id="search_form" method="get" action="search_1.php" class="searching-unit" data-regestered="regestered">
                                <div id="search">
                                    <span>&nbsp;处方个数</span>
                                    <select name="t">
                                ...
                                <input  type="text" id="query"  name="key" class="key" autocomplete="off"  value="<?php echo isset($_GET["key"])?$_GET["key"]:"";?>" placeholder="请输入你要查询的病症"   >

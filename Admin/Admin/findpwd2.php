...
<div id="myform">
    ...
    <form action="doFindPwdFinal.php" method="post" name="myForm" id="#" >
        <fieldset>
            <legend>找回管理员密码</legend>
            <div>
                <label for="Name">用户名</label>
                <input type="text" name="Name" class="input" id="Name" size="20" maxlength="30" value="<?php echo $row['username'];?>" required="required" readonly="readonly"/>
                *(可输入字母数组下划线)<br>
            </div>
            <div>
                <label for="Email">email</label>
                <input type="text" name="Email" class="input" id="Email" size="20" maxlength="150" required="required" value="<?php echo $row['email'];?> " readonly="readonly"/>
                *<br>
            </div>
            <div>

...
//得到数据库中所有药品
$sql="select p.id,p.pName,p.mPrice,p.pDesc,p.pubTime,c.type from izmu_pro as p join izmu_cate c on p.cId=c.id {$where}  ";
...
$sql="select p.id,p.pName,p.mPrice,p.pDesc,p.pubTime,c.type from izmu_pro as p join izmu_cate c on p.cId=c.id {$where} {$orderBy} limit {$offset},{$pageSize}";
$rows=fetchAll($sql);
?>
<!doctype html>
<html>
                            ...
                            <tr>
                                ...
                                <td align="center">
					                        	...
					                        	<table class="table" cellspacing="0" cellpadding="0">
					                        		...
					                        		<tr>
					                        			<td width="20%"  align="right">药品类别</td>
					                        			<td><?php echo $row['type'];?></td>
					                        		</tr>

					                        		<tr>
					                        			<td  width="20%"  align="right">药品价格</td>
					                        			<td><?php echo $row['mPrice'];?></td>
					                        		</tr>

					                        		<tr>
					                        			<td width="20%"  align="right">药品图片</td>
					                        			<td>
					                        			<?php 
